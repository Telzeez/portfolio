...
import { Mail, Download, ChevronRight, Sparkles, Code, Terminal } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div ref={contentRef} className="space-y-8">
            <div className={`scroll-animate ${contentVisible ? 'scroll-animate-visible stagger-1' : ''}`}>
            ...
            <div className="space-y-4">
              <h1 className={`text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight scroll-animate ${
              ...
              <div className={`scroll-animate ${contentVisible ? 'scroll-animate-visible stagger-3' : ''}`}>
                ...
                <div className="flex items-center gap-2 mt-2">
                  ...
                  <span className="text-lg text-muted-foreground">That users love</span>
                </div>
              </div>
            </div>
            ...
            <div className={`flex flex-wrap gap-4 scroll-animate ${
            ...
            <div className={`scroll-animate ${contentVisible ? 'scroll-animate-visible stagger-7' : ''}`}>
          ...
          <div ref={imageRef} className="relative">
            <div className={`absolute -top-6 -right-6 w-72 h-72 bg-primary/10 rounded-full blur-3xl animate-pulse-slow scroll-animate ${
              imageVisible ? 'scroll-animate-visible' : ''
            }`}></div>
            <div className={`absolute -bottom-6 -left-6 w-64 h-64 bg-primary/5 rounded-full blur-3xl animate-pulse-slow delay-500 scroll-animate ${
              imageVisible ? 'scroll-animate-visible stagger-2' : ''
            }`}></div>
            
            <div className={`relative animate-float scroll-animate ${
              ...
              <div className="relative w-80 h-80 md:w-96 md:h-96 mx-auto">
                ...
                <div className={`absolute -top-4 -right-4 w-16 h-16 rounded-2xl bg-primary/20 backdrop-blur-sm border border-primary/30 flex items-center justify-center animate-float delay-300 scroll-animate ${
                  imageVisible ? 'scroll-animate-visible stagger-4' : ''
                }`}>
                  <Code className="h-6 w-6 text-primary" />
                </div>
                
                <div className={`absolute -bottom-4 -left-4 backdrop-blur-sm border border-primary/20 flex items-center justify-center animate-float delay-700 glass-container px-4 py-2 rounded-full scroll-animate ${
                  imageVisible ? 'scroll-animate-visible stagger-5' : ''
                }`}>
                  <div className="flex items-center gap-2">
                    <span className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></span>
                    <p className="text-sm font-bold text-foreground whitespace-nowrap">Available for hire</p>
                  </div>
                </div>
              </div>
            </div>
            
            <div className={`absolute bottom-8 right-0 scroll-animate ${
